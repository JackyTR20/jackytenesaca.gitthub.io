...
def recibeInsertRegisterUser(cedula, name, surname, id_area, id_rol, pass_user, Dirección):
    respuestaValidar = validarDataRegisterLogin(
        cedula, name, surname, pass_user,Dirección)
        ...
        try:
            with connectionBD() as conexion_MySQLdb:
                with conexion_MySQLdb.cursor(dictionary=True) as mycursor:
                    sql = """
                    INSERT INTO usuarios(cedula, nombre_usuario, apellido_usuario, id_area, id_rol, password, Dirección) 
